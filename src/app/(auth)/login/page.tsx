        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-[#E8F4FD] rounded-xl mb-4">
              <LogIn className="w-6 h-6 text-[#1E3A5F]" />
            </div>
          ...
          <form className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-medium text-[#1E3A5F]">Password</label>
                <Link href="/forgot-password" className="text-sm text-[#4DD4E8] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-gray-500 mt-6">
            ...
            <Link href="/register" className="text-[#4DD4E8] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
